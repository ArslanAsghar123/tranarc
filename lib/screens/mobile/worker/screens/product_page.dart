...
import 'package:tranarc/screens/mobile/worker/widgets/image_swipe.dart';
import 'package:tranarc/screens/mobile/worker/widgets/product_size.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          FutureBuilder(
            future: _firebaseServices.workerRef.doc(widget.productId).get(),
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Image(
                                image: AssetImage(
                                  "assets/mobile/images/tab_saved.png",
                                ),
                                height: 22.0,
                              ),
                            ),
