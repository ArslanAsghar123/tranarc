...
import 'package:tranarc/screens/mobile/product/models/CartItem.dart';
import 'package:tranarc/screens/mobile/product/models/OrderedProduct.dart';
...
class UserDatabaseHelper {
  static const String USERS1_COLLECTION_NAME = "users1";
  ...
  Future<void> createNewUser(String uid) async {
    await firestore.collection(USERS1_COLLECTION_NAME).doc(uid).set({
      DP_KEY: null,
      PHONE_KEY: null,
  ...
  Future<void> deleteCurrentUserData() async {
    ...
    final docRef = firestore.collection(USERS1_COLLECTION_NAME).doc(uid);
  ...
  Future<bool> isProductFavourite(String productId) async {
    ...
    final userDocSnapshot =
        firestore.collection(USERS1_COLLECTION_NAME).doc(uid);
  ...
  Future<List<String>> get addressesList async {
    ...
    final snapshot = await firestore
        .collection(USERS1_COLLECTION_NAME)
        .doc(uid)
  ...
  Future<String> get displayPictureForCurrentUser async {
    String uid = AuthentificationService().currentUser.uid;
    final userDocSnapshot =
        await firestore.collection(USERS1_COLLECTION_NAME).doc(uid).get();
